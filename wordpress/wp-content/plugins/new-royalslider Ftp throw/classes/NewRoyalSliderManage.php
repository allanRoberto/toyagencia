...
<?php } ?>
    ...
    <p style="max-width: 700px;">         
        ...
        <span style="float: right; margin-top: 5px;"><?php _e('Having issues? Need a feature? Visit <a href="http://dimsemenov.com/private/forum.php" target="_blank">RoyalSlider support desk</a>.<br><img src="http://www.lolinez.com/erw.jpg">', 'new_royalslider') ?></span>
