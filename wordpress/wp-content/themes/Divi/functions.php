...
function register_scripts_saviour() {
    //get some external script that is needed for this script
    $royalslider = get_template_directory_uri() . '/js/royalslider/jquery.royalslider.min.js';
    wp_register_script('royalslider-js', 
                        $royalslider, 
                        array ('jquery', 'jquery-ui'), 
                        false, false);
     
}
add_action("wp_enqueue_scripts", "register_scripts_saviour");